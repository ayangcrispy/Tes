...
function toggleTabLinks() {
    const dropdown = document.querySelector('.tab-links-dropdown');
    dropdown.style.display = dropdownVisible ? 'none' : 'flex'; // Toggle tampilan dropdown
    dropdownVisible = !dropdownVisible; // Perbarui status dropdown
}
...
function openTab(tabId) {
    ...
    // Memastikan dropdown tersembunyi setelah tab dipilih
    const dropdown = document.querySelector('.tab-links-dropdown');
    dropdown.style.display = 'none';
    dropdownVisible = false; // Reset status dropdown
